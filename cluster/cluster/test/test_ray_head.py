...
def main():
    ...
    for i in range(10):
        ...
        results = [gethostname.remote(gethostname.remote(())) for _ in range(1000)]
...
if __name__ == "__main__":
    # ray.init("ray://172.16.10.29:32001", runtime_env={"working_dir": "/workspace/cluster/docker", "pip": ["toolz", "requests"]})
    ray.init("ray://172.16.10.29:32001", include_dashboard=True, dashboard_host="127.0.0.1", dashboard_port="8265")
    main()
